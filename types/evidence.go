...
import (
	...
	//tmproto.DuplicateVoteEvidence is defined in evidence.proto
	//tmproto.LightClientAttackEvidence is defined in evidence.proto
	//tmproto.Validator is defined in validator.proto
	//tmproto.Evidence is defined in evidence.proto
	//tmproto.Evidence_DuplicateVoteEvidence is defined in the evidence.proto
	//tmproto.Evidence_LightClientAttackEvidence is defined in the evidence.proto
	//tmproto.SignedMsgType is defined in the types.proto
	tmproto "github.com/YunweiMao/tendermint/proto/tendermint/types"

	//abci.Evidence
	//abci.EvidenceType_DUPLICATE_VOTE
	//abci.Validator
...
//LightBlock is defined in local light.go
