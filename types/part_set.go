...
import (
	...
	//merkle.Proof is defined in merkle/proof.go
	//ProofFromProto() is defined in merkle/proof.go
	//ProofsFromByteSlices() is defined in merkle/proof.go, 
	//HashFromByteSlices() is defined in merkle.tree.go
	"github.com/YunweiMao/tendermint/crypto/merkle"

	//bits.BitsArray and bits.NewBitsArray are defined in libs/bits/bit_array.go
	...
	//Part and PartSetHeader are defined in types.proto
