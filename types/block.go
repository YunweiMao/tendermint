...
import (
	...
	//tmproto.Block is defined in block.proto
	//tmproto.Header is defined in types.proto
	//tmproto.CommitSig is defined in types.proto
	//tmproto.BlockIDFlag is defined in types.proto
	//tmproto.PrecommitType is defined in types.proto
	//tmproto.Commit is defined in types.proto
	//tmproto.Data is defined in types.proto
	//tmproto.EvidenceList is defined in evidence.proto
	//tmproto.Evidence is defined in evidence.proto
	//tmproto.BlockID is defined in types.proto
