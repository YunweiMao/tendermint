...
import (
	...
	//Client is defined in ./light/client.go
	//NewClient is defined in ./light/client.go
	//Logger is defined in ./light/client.go
	//MaxRetryAttempts is defined ./light/client.go
	//TrustOptions is defined in ./light/trust_options.go
	"github.com/YunweiMao/tendermint/light"

	//Provider is defined in ./light/provider/provider.go
	lightprovider "github.com/YunweiMao/tendermint/light/provider"

	//NewWithClient is defined in ./light/provider/http/http.go
	lighthttp "github.com/YunweiMao/tendermint/light/provider/http"

	//NewClient is in ./light/rpc/client.go
	lightrpc "github.com/YunweiMao/tendermint/light/rpc"

	//New is in ./light/store/db/db.go
	lightdb "github.com/YunweiMao/tendermint/light/store/db"

	//HTTP is in ./rpc/client/http/http.go
	//New() is in ./rpc/client/http/http.go
	rpchttp "github.com/YunweiMao/tendermint/rpc/client/http"
)
