...
import (
	...
	//RemoteClient is defined in ./rpc/client/interface.go
	rpcclient "github.com/YunweiMao/tendermint/rpc/client"

	//LightBlock is in ./types/light.go
	//Evidence is in ./types/evidence.go
	//ValidatorSet is in ./types/validator_set.go
	//Validator is in ./types/validator.go
	//ValidatorSetFromExistingValidators is in ./types/validator_set.go
	//SignedHeader is in ./types/light.go
	"github.com/YunweiMao/tendermint/types"

	//NewWithTimeout is in ./rpc/client/http/http.go
