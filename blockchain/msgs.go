...
import (
	...
	//BlockRequest and all other variables used in this module is definied in types.pb.go/types.proto
...
const (
	...
	//types.MaxBlockSizeBytes is defined in types/params.go
...
func ValidateMsg(pb proto.Message) error {
	...
	case *bcproto.BlockResponse:
		//types.BlockFromProto is defined in types/block.go
