...
import (
	...
	//store dependency has been removed
	"github.com/YunweiMao/tendermint/state"
	bcproto "github.com/YunweiMao/tendermint/proto/tendermint/blockchain"

	//NewSwitchReporter is defined in ./behaviour/reporter.go
	//BadMessage is defined in ./behaviour/peer_behaviour.go
	//Reporter is defined in ./behaviour/reporter.go
	//NewMockReporter is defined in ./behaviour/reporter.go
	"github.com/YunweiMao/tendermint/behaviour"
	
	//add sync ability to v2 blockchain reactor
