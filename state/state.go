...
import (
	...
	//Version and State are defined in proto/tendermint/state/types.proto
	tmstate "github.com/YunweiMao/tendermint/proto/tendermint/state"

	//ConsensusParams is defined in /proto/tendermint/types/params.proto
	tmproto "github.com/YunweiMao/tendermint/proto/tendermint/types"

	//Consensus is defined in /proto/tendermint/version/types.proto
	tmversion "github.com/YunweiMao/tendermint/proto/tendermint/version"

	//ValidatorSet is defined in /types/validator_set.go
	//ValidatorSetFromProto is defined in ./types/validator_set.go
	//NewValidatorSet is defined in ./types/validator_set.go
	//ValidatorSet is defined in ./types/validator_set.go
	//BlockID is defined in ./types/block.go
	//BlockIDFromProto is defined in ./types/block.go
	//Commit is defined in ./types/block.go
	//Block is defined in ./types/block.go
	//Tx is defined in ./types/tx.go
	//Evidence is defined in ./types/evidence.go
	//PartSet is defined in ./types/part_set.go
	//HashConsensusParams is defined in ./types/params.go
	//BlockPartSizeBytes is defined in ./types/params.go
	//GenesisDoc is defined in ./types/genesis.go
	//MakeBlock is defined in ./types/test_util.go
	"github.com/YunweiMao/tendermint/types"

	//WeightedTime is defined in ./types/time/time.go
	//NewWeightedTime is defined in ./types/time/time.go
	//WeightedMedian is defined in ./types/time/time.go
