...
import (
	...
	//MaxActiveIDs is in ./mempool/mempool.go
	//MempoolChannel is in ./mempool/mempool.go
	//TxInfo is in ./mempool/tx.go
	//ErrTxInCache is in ./mempool/mempool.go
	//PeerCatchupSleepIntervalMS is in ./mempool/mempool.go
	"github.com/YunweiMao/tendermint/mempool"

	"github.com/YunweiMao/tendermint/p2p"

	//Message is in ./proto/tendermint/mempool/types.proto
	//Message_Txs is in ./proto/tendermint/mempool/types.pb.go
	//Txs is in ./proto/tendermint/mempool/types.proto
	protomem "github.com/YunweiMao/tendermint/proto/tendermint/mempool"

	//PeerStateKey is in ./types/keys.go
	//Tx is in ./types/tx.go
