...
import (
	...
	//Group is in ./libs/autofile/group.go
	//OpenGroup is in ./libs/autofile/group.go
	//GroupReader is in ./libs/autofile/group.go
	auto "github.com/YunweiMao/tendermint/libs/autofile"
