...
import (
	...
	//PubKeyFromProto is in 
	cryptoenc "github.com/YunweiMao/tendermint/crypto/encoding"

	//PingRequest is in ./proto/tendermint/privval/types.proto
	//PubKeyRequest is in ./proto/tendermint/privval/types.proto
	//SignVoteRequest is in ./proto/tendermint/privval/types.proto
	//SignProposalRequest is in ./proto/tendermint/privval/types.proto
	privvalproto "github.com/YunweiMao/tendermint/proto/tendermint/privval"
