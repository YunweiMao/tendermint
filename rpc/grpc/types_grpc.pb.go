...
const (
	BroadcastAPI_Ping_FullMethodName        = "/tendermint.rpc.grpc.BroadcastAPI/Ping"
	BroadcastAPI_BroadcastTx_FullMethodName = "/tendermint.rpc.grpc.BroadcastAPI/BroadcastTx"
)
