...
import (
	//NewWSRPCFunc is in ./rpc/jsonrpc/server/rpc_func.go
	//NewRPCFunc is in ./rpc/jsonrpc/server/rpc_func.go
	rpc "github.com/YunweiMao/tendermint/rpc/jsonrpc/server"
)
