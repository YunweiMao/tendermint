...
import (
	...
	//Event is defined in ./abci/types/types.pb.go
	//ValidatorUpdate is defined in ./abci/types/types.pb.go
	//ConsensusParams is defined in ./abci/types/types.pb.go
	...
	//DefaultNodeInfo is defined in ./p2p/node_info.go
	//ConnectionStatus is defined in ./p2p/types.go
	"github.com/YunweiMao/tendermint/p2p"

	tmproto "github.com/YunweiMao/tendermint/proto/tendermint/types"

	//BlockMeta is in ./types/block_meta.go
	//GenesisDoc is in ./types/genesis.go
	//BlockID in ./types/block.go
	//Block in ./types/block.go
	//SignedHeader is in ./types/light.go
	//Header is defined in ./types/block.go
	//Commit is defined in ./types/block.go
	//Validator is defined in ./types/validator.go
	//Tx, TxProof is defined in ./types/tx.go
	//TMEventData is defined in ./types/events.go
