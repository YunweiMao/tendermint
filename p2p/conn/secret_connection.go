...
import (
	...
	//NewDelimitedWriter, NewDelimitedReader is defined in reader.go/writer.go
	...
	//Parallel is defiend in /libs/async/async.go
	"github.com/YunweiMao/tendermint/libs/async"

	//AuthSigMessage is defined in /proto/tendermint/p2p/conn.proto
