...
import (
	...
	//P2PConfig is defined in ./config/config.go
	"github.com/YunweiMao/tendermint/config"
	//CMap/NewCMap are defined in /libs/cmap/camp.go
	"github.com/YunweiMao/tendermint/libs/cmap"
	//rand/NewRand is defined in random.go
	"github.com/YunweiMao/tendermint/libs/rand"
	//BaseService, NewBaseService are defined in service.go
	"github.com/YunweiMao/tendermint/libs/service"
	
	//DefaultMConnConfig is defined in ./p2p/conn/connection.go
