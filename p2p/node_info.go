...
import (
	...
	//DefaultNodeInfo is defined in ./proto/tendermint/p2p/types.pb.go
	//ProtocolVersion is defined in ./proto/tendermint/p2p/types.pb.go
	//DefaultNodeInfoOther is defined in ./proto/tendermint/p2p/types.pb.go
