...
import (
	...
	//CMap is defined in libs/cmap/cmap.go
	//NewCMap() is defined in libs/cmap/cmap.go
	"github.com/YunweiMao/tendermint/libs/cmap"

	//ConnectionStatus is defined in /p2p/conn/connection.go
	//MConnection is defined in /p2p/conn/connection.go
	//ChannelDescriptor is defined in /p2p/conn/connection.go
	//MConnConfig is defined in /p2p/conn/connection.go
	//NewMConnectionWithConfig is defined in /p2p/conn/connection.go
	//SecretConnection is defined in /p2p/conn/secret_connection.go
	tmconn "github.com/YunweiMao/tendermint/p2p/conn"
)
